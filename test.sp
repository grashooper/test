...
public OnPluginEnd(){
	...
	{
		StopSound(ent, SNDCHAN_STATIC, "custom/gameplay/health.ogg");
...
void UpdateRespawnCvars(){
	...
	if (g_easterEggRound == true)
	{
		...
		PrintToChatAll("************НАЙДЕНА ПАСХАЛКА************");
		PrintToChatAll("*НЕ НЫТЬ, ХОРОШО СЕБЯ ВЕСТИ, ВЕСЕЛИТЬСЯ*");
		PrintToChatAll("******МАКС РАУНДОВ ИЗМЕНЕНО ДО 2!*******");
		PrintToChatAll("*****РАБОТАЕМ ВМЕСТЕ, АДАПТИРУЕМСЯ!*****");
		PrintToChatAll("************НАЙДЕНА ПАСХАЛКА************");
	}
...
public OnMapStart(){	
    ...
    // Healing sounds and PRO
	PrecacheSound("custom/gameplay/05_heart_2.ogg");
	PrecacheSound("custom/gameplay/breath_mid_3.ogg");
	PrecacheSound("custom/gameplay/fatal.ogg");
	PrecacheSound("physics/body/body_medium_impact_hard3.wav");
	PrecacheSound("player/unprone.wav");
	PrecacheSound("hq/security/enemyout1.ogg");
	PrecacheSound("hq/security/enemyout2.ogg");
	PrecacheSound("hq/security/enemyout3.ogg");
	PrecacheSound("hq/security/enemyout4.ogg");
	PrecacheSound("hq/security/enemyout5.ogg");
	PrecacheSound("hq/security/enemyout6.ogg");
	PrecacheSound("hq/security/enemyout7.ogg");
	PrecacheSound("hq/security/enemyout8.ogg");
	PrecacheSound("hq/security/enemyout9.ogg");
	
	//medic gogo
	PrecacheSound("player/voice/botsurvival/subordinate/aggressiveinv1.ogg");
	PrecacheSound("player/voice/botsurvival/subordinate/aggressiveinv2.ogg");
	PrecacheSound("player/voice/botsurvival/subordinate/aggressiveinv3.ogg");
	PrecacheSound("player/voice/botsurvival/subordinate/aggressiveinv4.ogg");
    PrecacheSound("player/voice/botsurvival/subordinate/aggressiveinv7.ogg");
	PrecacheSound("player/voice/botsurvival/subordinate/aggressiveinv8.ogg");
	PrecacheSound("player/voice/botsurvival/subordinate/aggressiveinv14.ogg");
	...
	//Grenade Call Out Insurgent leader
	PrecacheSound("player/voice/bot/leader/incominggrenade1.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade2.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade3.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade4.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade5.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade6.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade7.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade8.ogg");
	...
	PrecacheSound("player/voice/bot/leader/incominggrenade14.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade15.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade16.ogg");
	...
	PrecacheSound("player/voice/bot/leader/incominggrenade24.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade25.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade26.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade27.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade28.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade29.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade30.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade31.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade32.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade33.ogg");
	PrecacheSound("player/voice/bot/leader/incominggrenade34.ogg");
	
	//Grenade Call Out Insurgent
	...
	PrecacheSound("player/voice/bot/subordinate/incominggrenade6.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade7.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade8.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade9.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade10.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade11.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade12.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade13.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade14.ogg");
	...
	PrecacheSound("player/voice/bot/subordinate/incominggrenade17.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade18.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade19.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade20.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade21.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade22.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade23.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade24.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade25.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade26.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade27.ogg");
	PrecacheSound("player/voice/bot/subordinate/incominggrenade28.ogg");
	...
	g_iBeaconHalo = PrecacheModel("sprites/halo01.vmt");
	// Healing sounds
	PrecacheSound("custom/gameplay/breath_mid_3.wav");
	PrecacheSound("custom/gameplay/health.ogg");
	PrecacheSound("custom/gameplay/fatal.ogg");
	// Destory, Flip sounds
	PrecacheSound("soundscape/emitters/oneshot/radio_explode.ogg");
	PrecacheSound("cues/music_loop_01.wav");	

//	AddFileToDownloadsTable("models/hlthkit/v_c4_sec.dx90.vtx");
//  AddFileToDownloadsTable("models/hlthkit/v_c4_sec.mdl");
//	AddFileToDownloadsTable("models/hlthkit/v_c4_sec.vvd");
//  AddFileToDownloadsTable("models/hlthkit/v_c4_sec_anims.dx90.vtx");
//  AddFileToDownloadsTable("models/hlthkit/v_c4_sec_anims.mdl");
//  AddFileToDownloadsTable("models/hlthkit/v_c4_sec_anims.vvd");
//  AddFileToDownloadsTable("models/hlthkit/w_c4._animsdx90.vtx");
//  AddFileToDownloadsTable("models/hlthkit/w_c4.dx90.vtx");
//  AddFileToDownloadsTable("models/hlthkit/w_c4.mdl");
//	AddFileToDownloadsTable("models/hlthkit/w_c4.vvd");
//  AddFileToDownloadsTable("models/hlthkit/w_c4_anims.mdl");
//  AddFileToDownloadsTable("models/hlthkit/w_c4_anims.phy");
//  AddFileToDownloadsTable("models/hlthkit/w_c4_anims.vvd");
//	AddFileToDownloadsTable("sound/custom/gameplay/breath_mid_3.wav");
//	AddFileToDownloadsTable("sound/custom/gameplay/health.ogg");
...
void Dynamic_Loadouts(){
	...
	SetConVarString(hTheaterOverride, "coop2_hardcore_18_players", true, false);	
	
	//Occurs counter attack
	// if (fRandom >= 0.01 && fRandom < 0.50)
	// {
		// SetConVarString(hTheaterOverride, "coop2_hardcore_18_players", true, false);
		// g_easterEggFlag = false;
	// }
	// else if (fRandom >= 0.50 && fRandom < 0.99)
	// {
	    // SetConVarString(hTheaterOverride, "coop2_hardcore_18_players_all_weapon", true, false);
	    // g_easterEggFlag = false;
	// }	
//	else if (fRandom >= 0.71 && fRandom < 0.95)
//	{
//	    SetConVarString(hTheaterOverride, "coop2_hardcore_18_players.theater_doi_weapon", true, false);
//	    g_easterEggFlag = false;
//	}	

//	if (fRandom >= 0.0 && fRandom < 0.50)
//	{
//		g_easterEggFlag = false;
//		new Float:fRandom_mil = GetRandomFloat(0.0, 1.0);
//		if (fRandom >= 0.5)
//			SetConVarString(hTheaterOverride, "coop2_hardcore_18_players.theater", true, false);
//	    else
//			SetConVarString(hTheaterOverride, "coop2_hardcore_18_players.theater_doi_weapon", true, false);		
//	}	
	
//	if (fRandom >= 0.50 && fRandom < 0.40)
//	{
//		SetConVarString(hTheaterOverride, "coop2_hardcore_18_players.theater", true, false);
//		g_easterEggFlag = false;
//	}
//	else if (fRandom >= 0.0 && fRandom < 0.50)
//	{
//	    SetConVarString(hTheaterOverride, "coop2_hardcore_18_players.theater_doi_weapon", true, false);
//	    g_easterEggFlag = false;
//	}
	...
	for (new client = 1; client <= MaxClients; client++)
	{
		if (IsClientInGame(client) && IsClientConnected(client) && !IsFakeClient(client) && playerPickSquad[client] == 1)
		{
			...
			if (g_iPlayerRespawnTimerActive[client] == 0 && !IsPlayerAlive(client) && !IsClientTimingOut(client) && IsClientObserver(client) && team == TEAM_1 && g_iEnableRevive == 1 && g_iRoundStatus == 1) //
			{
				...
				{
					PrintCenterText(client, "%t", "player_change_role_squad");
				}

				new String:woundType[128];
				//woundType = "WOUNDED";
				Format(woundType, sizeof(woundType), "%t", "wounded");
				if (g_playerWoundType[client] == 0)
					//woundType = "MINORLY WOUNDED";
					Format(woundType, sizeof(woundType), "%t", "minorly_wounded");
				else if (g_playerWoundType[client] == 1)
					//woundType = "MODERATELY WOUNDED";
					Format(woundType, sizeof(woundType), "%t", "moderately_wounded");
				else if (g_playerWoundType[client] == 2)
					//woundType = "CRITCALLY WOUNDED";
					Format(woundType, sizeof(woundType), "%t", "critically_wounded");
				...
				if (!g_iCvar_respawn_enable || g_iRespawnCount[2] == -1 || g_iSpawnTokens[client] <= 0)
				{
					...
					if (g_iHurtFatal[client] == 1)
					{
						...
						Format(fatal_hint, 255,"%t", "player_fatal_kill", g_clientDamageDone[client]);
					...
					else if (g_iHurtFatal[client] == 0 && !Ins_InCounterAttack())
					{
						...
						Format(wound_hint, 255,"%t", "player_was_killed", woundType, g_clientDamageDone[client]);
					...
					else if (g_iHurtFatal[client] == 0 && Ins_InCounterAttack())
					{
						...
						Format(wound_hint, 255,"%t", "player_was_killed_counter_attack",woundType, g_clientDamageDone[client]);
						PrintCenterText(client, "%s", wound_hint);
					}
				}
			}
...
public Action:Timer_Enemies_Remaining(Handle:Timer){
	...
	if (validAntenna != -1 || g_jammerRequired == 0)
	{
		...
		Format(textToPrintChat, sizeof(textToPrintChat), "%t", "show_enemy_alive_reinforce_left",alive_insurgents, g_iRemaining_lives_team_ins);
		Format(textToPrint, sizeof(textToPrint), "%t", "show_enemy_alive_reinforce_left", alive_insurgents ,g_iRemaining_lives_team_ins);
		PrintHintTextToAll(textToPrint);
		PrintToChatAll(textToPrintChat);
	}
	else
	{
		...
		//Format(textToPrintChat, sizeof(textToPrintChat), "[INTEL]Comms are down, build jammer to get enemy reports.");
		//Format(textToPrint, sizeof(textToPrintChat), "[INTEL]Comms are down, build jammer to get enemy reports.");
		Format(textToPrintChat, sizeof(textToPrintChat), "%t","build_jammer_get_enemy");
		Format(textToPrint, sizeof(textToPrintChat), "%t","build_jammer_get_enemy");
		PrintHintTextToAll(textToPrint);
		PrintToChatAll(textToPrintChat);
	}
	return Plugin_Continue;
...
void AI_Director_RandomEnemyReinforce(){
	...
	if (g_iRemaining_lives_team_ins > 0)
	{
		...
		// {
			...
			Format(textToPrint, sizeof(textToPrint), "%t", "ambush_reinforce_add");
			Format(textToPrint, sizeof(textToPrintChat), "%t", "ambush_reinforce_add");
			// EmitSoundToAll("hq/security/enemyout5.ogg");
			switch(GetRandomInt(1, 9))
			{
				case 1: EmitSoundToAll("hq/security/enemyout1.ogg");
				case 2: EmitSoundToAll("hq/security/enemyout2.ogg");
				case 3: EmitSoundToAll("hq/security/enemyout3.ogg");
				case 4: EmitSoundToAll("hq/security/enemyout4.ogg");
				case 5: EmitSoundToAll("hq/security/enemyout5.ogg");
				case 6: EmitSoundToAll("hq/security/enemyout6.ogg");
				case 7: EmitSoundToAll("hq/security/enemyout7.ogg");
				case 8: EmitSoundToAll("hq/security/enemyout8.ogg");
				case 9: EmitSoundToAll("hq/security/enemyout9.ogg");
			}
	...
	else
	{
		...
		Format(textToPrint, sizeof(textToPrint), "%t","ambush_reinforce_incoming");
		Format(textToPrint, sizeof(textToPrintChat), "%t","ambush_reinforce_incoming");
		...
		if (g_iReinforceTime % 10 == 0 && g_iReinforceTime > 10)
		{
			...
			if (validAntenna != -1 || g_jammerRequired == 0)
			{
				...
				if (g_isHunt == 1)
				{
					...
					Format(textToPrint, sizeof(textToPrint), "%t", "show_enemy_reinforce_kill_rest_blow", g_iReinforceTime);
					Format(textToPrintChat, sizeof(textToPrintChat), "%t", "show_enemy_reinforce_kill_rest_blow", g_iReinforceTime);
				}
				else
				{
					...
					Format(textToPrint, sizeof(textToPrint), "%t", "show_enemy_reinforce_capture_point", g_iReinforceTime);
					Format(textToPrintChat, sizeof(textToPrintChat), "%t", "show_enemy_reinforce_capture_point", g_iReinforceTime);
				}
		...
		if (g_iReinforceTime <= 0)
		{
			...
			if (g_iRemaining_lives_team_ins > 0)
			{
				...
				if (g_iRemaining_lives_team_ins < (g_iRespawn_lives_team_ins / g_iReinforce_Mult) + g_iReinforce_Mult_Base)
				{
					...
					Format(textToPrint, sizeof(textToPrint), "%t", "enemy_reinforce_added");
					Format(textToPrintChat, sizeof(textToPrintChat), "%t", "enemy_reinforce_added");
				...
				else
				{
					...
					Format(textToPrint, sizeof(textToPrint), "%t","enemy_reinforce_max_capacity");
					Format(textToPrintChat, sizeof(textToPrintChat), "%t","enemy_reinforce_max_capacity");
					if (validAntenna != -1 || g_jammerRequired == 0)
					{
						PrintHintTextToAll(textToPrint);
						PrintToChatAll(textToPrintChat);
			...
			else
			{
				...
				Format(textToPrint, sizeof(textToPrint), "%t", "enemy_reinforce_have_arrived");
				Format(textToPrintChat, sizeof(textToPrintChat), "%t", "enemy_reinforce_have_arrived");
				switch(GetRandomInt(1, 9))
				{
					case 1: EmitSoundToAll("hq/security/enemyout1.ogg");
					case 2: EmitSoundToAll("hq/security/enemyout2.ogg");
...
void SecTeamLivesBonus(){
	...
	if (secTeamCount <= 6)
	{
		g_iRespawnCount[2] += (GetConVarInt(sm_respawn_lives_team_sec) * 3);
	}
	else if (secTeamCount >= 7 && secTeamCount <= 12)
	{
		g_iRespawnCount[2] += (GetConVarInt(sm_respawn_lives_team_sec) * 2);
	}
}

//Adjust Lives Per Point Based On Players
public Action:Timer_DynLivesPerPoint(Handle:Timer){
	new secTeamCount = GetTeamSecCount();
	if (secTeamCount <= 6)
	{
		g_iRespawnCount[2] = (GetConVarInt(sm_respawn_lives_team_sec) * 3);
	...
	{
		g_iRespawnCount[2] = (GetConVarInt(sm_respawn_lives_team_sec) * 2) - 1;
	}
	return Plugin_Continue;
}
...
public Action:Event_RoundEnd_Pre(Handle:event, const String:name[], bool:dontBroadcast){
	...
	for (new client = 1; client <= MaxClients; client++)
	{
		...
		if (tTeam != TEAM_1)
			continue;
		if ((g_iStatRevives[client] > 0 || g_iStatHeals[client] > 0) && StrContains(g_client_last_classstring[client], "template_demolitions_security_coop") > -1)
		{
			decl String:sBuf[255];
			// Hint to iMedic
			//Format(sBuf, 255,"[MEDIC STATS] for %N: HEALS: %d | REVIVES: %d", client, g_iStatHeals[client], g_iStatRevives[client]);
			Format(sBuf, 255,"%t","msg_medic_stats_player", client, g_iStatHeals[client], g_iStatRevives[client]);
...
public Action:Event_ControlPointCaptured_Pre(Handle:event, const String:name[], bool:dontBroadcast){
	...
	new secTeamCount = GetTeamSecCount();
	new secTeamAliveCount = Team_CountAlivePlayers(TEAM_1);
	...
	if (fRandom < g_respawn_counter_chance && g_isCheckpoint == 1 && ((acp+1) != ncp))
	{
		...
		if (largeCounterEnabled)
		{
			...
			PrintHintTextToAll("%t","enemy_force_send_conter_attack_ready_deffend");
			PrintToChatAll("%t","enemy_force_send_conter_attack_ready_deffend");
		}
...
public Action:serverhelp(client, args) { 
	...
	PrintToChat(client, "%t","msg_server_help");
	return Plugin_Handled;
}
...
public Action:SquadSpawn(client, args) { 
		...
		StrContains(g_client_last_classstring[client], "Gnalvl_teamleader_recon_usmc") > -1) )
	{
		...
		PrintToChat(client, "%t", "squad_spawn_cant_leader");
		g_squadSpawnEnabled[client] = 0;
		return Plugin_Handled;
	}
	...
	if (g_squadSpawnEnabled[client] == 1)
	{
		...
		PrintToChat(client, "%t", "squad_spawn_disabled");
	}
	else
	{
		g_squadSpawnEnabled[client] = 1;
		//PrintToChat(client, "[SQUAD_SPAWN] Squad spawning enabled!");
		PrintToChat(client, "%t", "squad_spawn_enabled");
...
public Action:Timer_SquadSpawn_Notify(Handle:timer, any:data){
	...
	for(new tLeader = 1; tLeader <= MaxClients; tLeader++)
	{
		...
		if (iTeam == TEAM_1 && StrContains(g_client_last_classstring[tLeader], "Gnalvl_squadleader_usmc") > -1 && IsPlayerAlive(tLeader))
		{
			tSquadLeader = tLeader;
		}
		else if (iTeam == TEAM_1 && StrContains(g_client_last_classstring[tLeader], "gnalvl_teamleader_usmc") > -1 && IsPlayerAlive(tLeader))
		{
			tTeamLeader = tLeader;
		}
		else if (iTeam == TEAM_1 && StrContains(g_client_last_classstring[tLeader], "Gnalvl_teamleader_recon_usmc") > -1 && IsPlayerAlive(tLeader))
		{
	...
	for(new tClient = 1; tClient <= MaxClients; tClient++)
	{
		...
		if (g_squadSpawnEnabled[tClient] == 1 && iTeam == TEAM_1 && !IsPlayerAlive(tClient) && (!StrContains(g_client_last_classstring[tClient], "Gnalvl_squadleader_usmc") > -1) &&
	...
	if (tSL_HasSpawner == 1)
	{
		...
		Format(sNotifyLeader, sizeof(sNotifyLeader),"%t", "squadmate_reinforce", tSL_lowestClient, g_iRespawnTimeRemaining[tSL_lowestClient]);
	...
	if (tTL_HasSpawner == 1)
	{
		...
		Format(sNotifyLeader, sizeof(sNotifyLeader),"%t", "squadmate_reinforce", tTL_lowestClient, g_iRespawnTimeRemaining[tTL_lowestClient]);
	...
	if (tRTL_HasSpawner == 1)
	{
		...
		Format(sNotifyLeader, sizeof(sNotifyLeader),"%t", "squadmate_reinforce", tRTL_lowestClient, g_iRespawnTimeRemaining[tRTL_lowestClient]);
...
public FindSquadLeader(String:leaderClassString[64]) { 
	...
	for(new tLeader = 1; tLeader <= MaxClients; tLeader++)
	{
		...
		new iTeam = GetClientTeam(tLeader);
		if (iTeam == TEAM_1 && StrContains(g_client_last_classstring[tLeader], leaderClassString) > -1)
		{
			return tLeader;
		}
	}
...
public Action:cmd_kill(client, args) {
	...
	PrintToChatAll("\x05%N\x01 %t", client,"use_kill_all", g_trackKillDeaths[client]);
	PrintToChat(client, "\x04[SERNIX RULES] %t", "Abusing kill command is not allowed! | Times used %d | Abusing for ammo = ban", g_trackKillDeaths[client]);
	return Plugin_Handled;
}
	...
	if (g_iCvar_respawn_type_team_sec == 1)
	{
		for (new client=1; client<=MaxClients; client++)
		{
			...
			if (client > 0 && IsClientInGame(client))
			{
				...
				{
					if (StrContains(g_client_last_classstring[client], "template_demolitions_security_coop") > -1 && !((acp+1) == ncp))
...
public Action:Event_PlayerPickSquad_Post( Handle:event, const String:name[], bool:dontBroadcast ){
	...
	// Get player nickname
	decl String:sNewNickname[128];
	// Medic class
	if (StrContains(g_client_last_classstring[client], "template_demolitions_security_coop") > -1){
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_medic", g_client_org_nickname[client]);
		// Donor medic
		...
		// Normal medic
			...
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_medic",g_client_org_nickname[client]);
		    PrintCenterTextAll("Now %s is Medic.", sNewNickname);
			EmitSoundToAll("player/unprone.wav");
	}
	else if (StrContains(g_client_last_classstring[client], "template_specialist_security_coop") > -1){
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_doctor", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_doctor", g_client_org_nickname[client]);
		// Normal medic
			...
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_doctor",g_client_org_nickname[client]);
		    PrintCenterTextAll("Now %s is DOCTOR.", sNewNickname);
			EmitSoundToAll("player/unprone.wav");
	}
	else if (StrContains(g_client_last_classstring[client], "specialist") > -1){
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_specialist", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_specialist", g_client_org_nickname[client]);
		// Normal medic
		...
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_breacher", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_breacher", g_client_org_nickname[client]);
		// Normal medic
		...
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_rifleman", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_rifleman", g_client_org_nickname[client]);
		// Normal medic
		...
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_grenadier", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_grenadier", g_client_org_nickname[client]);
		// Normal medic
		...
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_support", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_support", g_client_org_nickname[client]);
		// Normal medic
		...
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_recon", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_recon", g_client_org_nickname[client]);
		// Normal medic
	...
	else if (StrContains(g_client_last_classstring[client], "template_coop_specialist") > -1){
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_scout", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_scout", g_client_org_nickname[client]);
		// Normal medic
	...
	else if (StrContains(g_client_last_classstring[client], "specop") > -1){
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_specop", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_specop", g_client_org_nickname[client]);
		// Normal medic
		...
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_demolitions", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_demolitions", g_client_org_nickname[client]);
		// Normal medic
		...
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_sniper", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_sniper", g_client_org_nickname[client]);
		// Normal medic
		...
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_marksman", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_marksman", g_client_org_nickname[client]);
		// Normal medic
		...
		// Admin medic
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_leader", g_client_org_nickname[client]);
		// Donor medic
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_leader", g_client_org_nickname[client]);
		// Normal medic
	...
	// Normal class
		...
		// Admin
		if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_ROOT))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_normal", g_client_org_nickname[client]);
		// Donor
		else if (GetConVarInt(sm_respawn_enable_donor_tag) == 1 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION))
			Format(sNewNickname, sizeof(sNewNickname), "%t", "class_normal", g_client_org_nickname[client]);
		// Normal player
...
public Action:Event_PlayerDeath(Handle:event, const String:name[], bool:dontBroadcast){
	...
	//AI Director START
	//Bot Team AD Status
	if (team == TEAM_2 && g_iRoundStatus == 1 && attackerTeam == TEAM_1)
	{
	...
	if (team == TEAM_1 && g_iRoundStatus == 1)
	{
		if (g_iHurtFatal[client] == 1)
			...
			)
			{
				...
				else if (g_iCvar_respawn_type_team_sec == 1 && team == TEAM_1)
				{
					...
					else if (g_iSpawnTokens[client] <= 0 && g_iRespawnCount[team] > 0)
					{
						...
						Format(sChat, 128,"%t","player_cannot_respawned_anymore");
	...
	decl String:wound_hint[128];
	decl String:fatal_hint[128];
	decl String:woundType[128];
	if (g_playerWoundType[client] == 0){
		//woundType = "MINORLY WOUNDED";
		Format(woundType, sizeof(woundType), "%t", "minorly_wounded");
	}
		...
		if (g_fCvar_fatal_chance > 0.0)
		{
			if (g_iHurtFatal[client] == 1 && !IsFakeClient(client))
			{
				...
				Format(fatal_hint, 255,"%t", "player_fatally_killed", g_clientDamageDone[client]);
				PrintHintText(client, "%s", fatal_hint);
				PrintToChat(client, "%s", fatal_hint);
				EmitSoundToClient(client, "custom/gameplay/fatal.ogg");
			}
			else
			{
				//Format(wound_hint, 255,"You're %s for %i damage, call a medic for revive!", woundType, g_clientDamageDone[client]);
				Format(wound_hint, 255, "%t", "player_was_wounded_call_medic", woundType, g_clientDamageDone[client]);				
...
public Action:RespawnPlayerRevive(Handle:Timer, any:client){
	...
	PrintToChatAll("\x01\x0759b0f9[MEDIC]\x01 Вперед в бой !");
	PrintToChatAll("\x01\x0759b0f9[MEDIC]\x01 Go to battle!");
	EmitSoundToAll("physics/body/body_medium_impact_hard3.wav");
...
public Action:Timer_ReviveMonitor(Handle:timer, any:data){
	...
	for (new iMedic = 1; iMedic <= MaxClients; iMedic++)
	{
		...
		// Is valid iMedic?
		if (IsPlayerAlive(iMedic) && (StrContains(g_client_last_classstring[iMedic], "template_demolitions_security_coop") > -1))
		{
				...
				)
				{
					...
					if (g_iReviveRemainingTime[iInjured] > 0)
					{
						...
						if (g_playerWoundType[iInjured] == 0){
							...
							Format(woundType, sizeof(woundType), "%t", "minor_wounded");
						}
						else if (g_playerWoundType[iInjured] == 1){
							//woundType = "Moderate wound";
							Format(woundType, sizeof(woundType), "%t", "moderate_wounded");
						}
						else if (g_playerWoundType[iInjured] == 2){
							//woundType = "Critical wound";
							Format(woundType, sizeof(woundType), "%t", "critical_wounded");
						}
						
						// Hint to iMedic
						//Format(sBuf, 255,"Reviving %N in: %i seconds (%s)", iInjured, g_iReviveRemainingTime[iInjured], woundType);
						Format(sBuf, 255, "%t", "reviving_msg_medic", iInjured, g_iReviveRemainingTime[iInjured], woundType);
						...
						Format(sBuf, 255,"%t", "reviving_msg_player", iMedic, g_iReviveRemainingTime[iInjured], woundType);
					...
					{	
						...
						if (g_playerWoundType[iInjured] == 0){
							//woundType = "minor wound";
							Format(woundType, sizeof(woundType), "%t", "minor_wounded_revive_player");
						}
						else if (g_playerWoundType[iInjured] == 1){
							//woundType = "moderate wound";
							Format(woundType, sizeof(woundType), "%t", "moderate_wounded_revive_player");
						}
						else if (g_playerWoundType[iInjured] == 2){
							//woundType = "critical wound";
							Format(woundType, sizeof(woundType), "%t", "critical_wounded_revive_player");
						}
						
						
						// Chat to all
						//Format(sBuf, 255,"\x05%N\x01 revived \x03%N from a %s", iMedic, iInjured, woundType);
						Format(sBuf, 255,"\x05%t\x01", "revived_msg_all", iMedic, iInjured, woundType);
						PrintToChatAll("%s", sBuf);
						
						// Hint to iMedic
						//Format(sBuf, 255,"You revived %N from a %s", iInjured, woundType);
						Format(sBuf, 255,"%t", "revived_msg_medic", iInjured, woundType);
						PrintHintText(iMedic, "%s", sBuf);
						
						// Hint to victim
						//Format(sBuf, 255,"%N revived you from a %s", iMedic, woundType);
						Format(sBuf, 255,"%t", "revived_msg_player", iMedic, woundType);
						PrintHintText(iInjured, "%s", sBuf);
						...
						Format(sBuf, 255, "%t", "revived_msg_medic_bonus", iInjured, woundType, (iReviveCap - g_playerMedicRevivessAccumulated[iMedic]));
						PrintHintText(iMedic, "%s", sBuf);
						...
						if (g_playerMedicRevivessAccumulated[iMedic] >= iReviveCap)
						{
							...
							Format(sBuf2, 255,"%t", "revived_msg_medic_awward_reviving", 1, iReviveCap);
		...
		else if (IsPlayerAlive(iMedic) && !(StrContains(g_client_last_classstring[iMedic], "template_demolitions_security_coop") > -1))
		{
				...
				)
				{
					...
					if (g_iReviveNonMedicRemainingTime[iInjured] > 0){
						...
						if (g_playerWoundType[iInjured] == 0 || g_playerWoundType[iInjured] == 1 || g_playerWoundType[iInjured] == 2){
							...
							Format(sBuf, 255, "%t", "reviving_msg_medic", iInjured, g_iReviveNonMedicRemainingTime[iInjured], woundType);
							PrintHintText(iMedic, "%s", sBuf);
							
							// Hint to victim
							//Format(sBuf, 255,"%N is reviving you in: %i seconds (%s)", iMedic, g_iReviveNonMedicRemainingTime[iInjured], woundType);
							Format(sBuf, 255, "%t", "reviving_msg_player", iMedic, g_iReviveNonMedicRemainingTime[iInjured], woundType);
							PrintHintText(iInjured, "%s", sBuf);
...
public Action:Timer_MedicMonitor(Handle:timer){
	...
	for(new medic = 1; medic <= MaxClients; medic++)
	{
		...
		if (iTeam == TEAM_1 && IsPlayerAlive(medic) && StrContains(g_client_last_classstring[medic], "template_demolitions_security_coop") > -1)
		{
			...
			if(iTarget > 0 && iTarget <= MaxClients && IsClientInGame(iTarget) && IsPlayerAlive(iTarget) && iTeam == GetClientTeam(iTarget))
			{
				...
				if (tDistance < 750.0)
				{
					...
					PrintHintText(medic, "%t", "check_heal", iTarget, iHealth);
				}
				...
				if (bCanHealPaddle)
				{
					if (iHealth < 100)
					{
						...
						if (g_playerMedicHealsAccumulated[medic] >= iHealthCap && iRewardMedicEnabled == 1)
						{
							...
							Format(sBuf2, 255,"%t", "revived_msg_medic_awward_heal", 1, iHealthCap);
						...
						if (iHealth >= 100)
						{
							...
							PrintToChatAll("\x05%t\x01", "medic_heal_player_all", medic, iTarget);
							PrintHintText(iTarget, "%t", "you_were_healed_by", medic, iHealth);
							decl String:sBuf[255];
							...
							Format(sBuf, 255,"%t", "you_fully_healed_bonus", iTarget, (iHealthCap - g_playerMedicHealsAccumulated[medic]));
							PrintHintText(medic, "%s", sBuf);
							PrintToChat(medic, "%s", sBuf);
							EmitSoundToAll("custom/gameplay/breath_mid_3.ogg", iTarget, SNDCHAN_STATIC, _, _, 1.0);
							switch(GetRandomInt(1, 8))
							{
								case 1: EmitSoundToAll("player/voice/botsurvival/subordinate/aggressiveinv1.ogg", medic, SNDCHAN_VOICE, _, _, 1.0);
								case 2: EmitSoundToAll("player/voice/botsurvival/subordinate/aggressiveinv2.ogg", medic, SNDCHAN_VOICE, _, _, 1.0);
								case 3: EmitSoundToAll("player/voice/botsurvival/subordinate/aggressiveinv3.ogg", medic, SNDCHAN_VOICE, _, _, 1.0);
								case 4: EmitSoundToAll("player/voice/botsurvival/subordinate/aggressiveinv4.ogg", medic, SNDCHAN_VOICE, _, _, 1.0);
								case 5: EmitSoundToAll("player/voice/botsurvival/subordinate/aggressiveinv7.ogg", medic, SNDCHAN_VOICE, _, _, 1.0);
								case 6: EmitSoundToAll("player/voice/botsurvival/subordinate/aggressiveinv8.ogg", medic, SNDCHAN_VOICE, _, _, 1.0);
								case 7: EmitSoundToAll("player/voice/botsurvival/subordinate/aggressiveinv14.ogg", medic, SNDCHAN_VOICE, _, _, 1.0);
								case 8: EmitSoundToAll("player/voice/botsurvival/subordinate/aggressiveinv16.ogg", medic, SNDCHAN_VOICE, _, _, 1.0);
						    }
						}
						else
						{
							//PrintHintText(iTarget, "DON'T MOVE! %N is healing you.(HP: %i)", medic, iHealth);
							PrintHintText(iTarget, "%t", "dont_move_helling_you", medic, iHealth);
							EmitSoundToAll("custom/gameplay/05_heart_2.ogg", iTarget, SNDCHAN_STATIC, _, _, 1.0);
						}
						
						SetEntityHealth(iTarget, iHealth);
						//PrintHintText(medic, "%N\nHP: %i\n\nHealing with paddles for: %i", iTarget, iHealth, g_iHeal_amount_paddles);
						PrintHintText(medic, "%t", "helling_with_paddles", iTarget, iHealth, g_iHeal_amount_paddles);
					}
					else
					{
						//PrintHintText(medic, "%N\nHP: %i", iTarget, iHealth);
				...
				else if (bCanHealMedpack)
				{
					if (iHealth < 100)
					{
						...
						PrintHintText(medic, "%t", "helling_with_medpack", iTarget, iHealth, g_iHeal_amount_medPack);
					}
					else
					{
						//PrintHintText(medic, "%N\nHP: %i", iTarget, iHealth);
				...
				if (bCanHealMedpack || bCanHealPaddle)
				{
					if (iHealth < g_medicHealSelf_max)
					{
						...
						if (iHealth >= g_medicHealSelf_max)
						{
							...
							PrintHintText(medic, "%t", "you_healed_yourself", iHealth, g_medicHealSelf_max);
							EmitSoundToAll("custom/gameplay/breath_mid_3.ogg", iTarget, SNDCHAN_STATIC, _, _, 1.0);
						}
						else 
						{
							PrintHintText(medic, "Healing Self (HP: %i) | MAX: %i", iHealth, g_medicHealSelf_max);
							PrintHintText(medic, "%t", "you_healing_self", iHealth, g_medicHealSelf_max);
						}
		...
		else if (iTeam == TEAM_1 && IsPlayerAlive(medic) && !(StrContains(g_client_last_classstring[medic], "template_demolitions_security_coop") > -1))
		{
					...
					if (bCanHealMedpack)
					{
						if (iHealth < g_nonMedic_maxHealOther)
						{
							...
							if (iHealth >= g_nonMedic_maxHealOther)
							{
								...
								PrintHintText(iTarget, "%t", "nonmedic_can_heal", medic, iHealth);
								...
								Format(sBuf, 255,"%t", "you_max_healed_bonus", iTarget, (iHealthCap - g_playerNonMedicHealsAccumulated[medic]));
								PrintHintText(medic, "%s", sBuf);
								PrintToChat(medic, "%s", sBuf);
							}
							else
							...
							PrintHintText(medic, "%t", "you_healing_player", iTarget, iHealth);
						}
						else
						{
							if (iHealth < g_nonMedic_maxHealOther)
							...
							else if (iHealth >= g_nonMedic_maxHealOther)
							{
								...
								PrintHintText(medic, "%t", "nonmedic_max_can_heal", iTarget, iHealth);
							}
					...
					if (bCanHealMedpack)
					{
						if (iHealth < g_nonMedicHealSelf_max)
						{
							...
							if (iHealth >= g_nonMedicHealSelf_max)
							{
								...
								PrintHintText(medic, "%t", "you_healed_yourself", iHealth, g_nonMedicHealSelf_max);
								EmitSoundToAll("custom/gameplay/breath_mid_3.ogg", iTarget, SNDCHAN_STATIC, _, _, 1.0);
							}
							else
							{
								//PrintHintText(medic, "Healing Self (HP: %i) | MAX: %i", iHealth, g_nonMedicHealSelf_max);
								PrintHintText(medic, "%t", "you_healing_self", iHealth, g_nonMedicHealSelf_max);
							}
...
public Action:Timer_NearestBody(Handle:timer, any:data){
	...
	for (new medic = 1; medic <= MaxClients; medic++)
	{
		...
		// Valid medic?
		if (IsPlayerAlive(medic) && (StrContains(g_client_last_classstring[medic], "template_demolitions_security_coop") > -1))
		{
			// Reset variables
			iNearestInjured = 0;
			...
			if (iNearestInjured != 0)
			{
				...
				PrintCenterText(medic, "%t", "nav_nearest_dead", iNearestInjured, sDistance, sDirection, sHeight);
				new Float:beamPos[3];
		...
		else if (IsPlayerAlive(medic) && !(StrContains(g_client_last_classstring[medic], "template_demolitions_security_coop") > -1))
		{
			// Reset variables
			iNearestInjured = 0;
			fNearestDistance = 0.0;
...
String:GetDistanceString(Float:fDistance){
	...
	if (g_iUnitMetric == 1)
	{
		...
		Format(sResult, sizeof(sResult), "%.0f %t", fTempDistance, "nav_feet");
	}
	else
	{
		// Meter
		//Format(sResult, sizeof(sResult), "%.0f meter", fTempDistance);
		Format(sResult, sizeof(sResult), "%.0f %t", fTempDistance, "nav_meter");
	}
...
String:GetHeightString(Float:fClientPosition[3], Float:fTargetPosition[3]){
    ...
    {
        //s = "ABOVE";
		Format(s, sizeof(s), "%t", "nav_above");
    }
    else if (fClientPosition[2]-64 > fTargetPosition[2])
    {
        //s = "BELOW";
		Format(s, sizeof(s), "%t", "nav_below");
    }
    else
    {
        //s = "LEVEL";
		Format(s, sizeof(s), "%t", "nav_level");
    }
...
public LoadMySQLBase(Handle:owner, Handle:hndl, const String:error[], any:data){
	...
	// Get 'last_active'
	FormatEx(sQuery, sizeof(sQuery), "DELETE FROM hlstatsx WHERE last_active <= %i", GetTime() - PLAYER_STATSOLD * 12 * 60 * 60);
	SQL_TQuery(g_hDB, SQLErrorCheckCallback, sQuery);
}
...
public Action:initPlayerBase(Handle:timer, any:client){
	if (g_hDB != INVALID_HANDLE)
	{
		...
		Format(buffer, sizeof(buffer), "SELECT * FROM hlstatsx WHERE steamId = '%s'", g_sSteamIdSave[client]);
		if(DEBUG == 1){
...
public Action:Command_Say(client, args)
{
	...
	if (strcmp(text[startidx], "/rank", false) == 0 || strcmp(text[startidx], "!rank", false) == 0 || strcmp(text[startidx], "rank", false) == 0)	{
		if(g_iUserFlood[client] != 1){
			...
			PrintToChat(client,"%c %t", GREEN, "dont_flood");
		}
	}
	// Top10
	...
	{		
		if(g_iUserFlood[client] != 1){
			...
			PrintToChat(client, "%c %t", GREEN, "dont_flood", GREEN);
		}
	}
	return Plugin_Continue;
}
...
public GetMyRank(client){
	...
	if (g_hDB != INVALID_HANDLE)
	{
		...
		if(g_iUserInit[client] == 1){
			...
			decl String:buffer[200];
			Format(buffer, sizeof(buffer), "SELECT `score`, `kills`, `deaths`, `headshots`, `sucsides`, `revives`, `heals` FROM `hlstatsx` WHERE `steamId` = '%s' LIMIT 1", g_sSteamIdSave[client]);
			if(DEBUG == 1){
		...
		{
			PrintToChat(client,"%c %t", GREEN, "wait_system_load_db");
		}
	}
	else
	{
		PrintToChat(client, "%c %t", GREEN, "rank_sys_not_avaible");
	}
}
...
public showTOP(client){
	...
	if (g_hDB != INVALID_HANDLE)
	{
		// Get Top10
		decl String:buffer[200];
		//Format(buffer, sizeof(buffer), "SELECT *, (`deaths`/`kills`) / `played_time` AS rankn FROM `hlstatsx` WHERE `kills` > 0 AND `deaths` > 0 ORDER BY rankn ASC LIMIT 10");
		Format(buffer, sizeof(buffer), "SELECT *, `score` AS rankn FROM `hlstatsx` WHERE `score` > 0 ORDER BY rankn DESC LIMIT 10");
		if(DEBUG == 1){
...
public showTOPMedics(client){
	...
	if (g_hDB != INVALID_HANDLE)
	{
		// Get HadHunters
		decl String:buffer[200];
		Format(buffer, sizeof(buffer), "SELECT * FROM hlstatsx ORDER BY revives, heals DESC LIMIT 10");
		if(DEBUG == 1){
...
public showTOPHeadHunter(client){
	...
	if (g_hDB != INVALID_HANDLE)
	{
		// Get HadHunters
		decl String:buffer[200];
		Format(buffer, sizeof(buffer), "SELECT * FROM hlstatsx ORDER BY headshots DESC LIMIT 10");
		if(DEBUG == 1){
...
public SQLUserLoad(Handle:owner, Handle:hndl, const String:error[], any:client){
	if(SQL_FetchRow(hndl))
	{
		...
		Format(buffer, sizeof(buffer), "UPDATE hlstatsx SET nick = '%s', last_active = '%i' WHERE steamId = '%s'", name, GetTime(), g_sSteamIdSave[client]);
		if(DEBUG == 1){
	...
	else
	{
		...
		// Add new record
		Format(buffer, sizeof(buffer), "INSERT INTO hlstatsx (steamId, nick, last_active) VALUES('%s', '%s', '%i')", g_sSteamIdSave[client], name, GetTime());
		if(DEBUG == 1){
			PrintToServer("DEBUG: SQLUserLoad (%s)", buffer);
		}
		SQL_TQuery(g_hDB, SQLErrorCheckCallback, buffer);
...
void SQLDisplayJoinMessage(client)
{
	// Get current score
	decl String:buffer[512];
	Format(buffer, sizeof(buffer), "SELECT score FROM hlstatsx WHERE steamId = '%s'", g_sSteamIdSave[client]);
...
public SQLJoinMsgGetScore(Handle:owner, Handle:hndl, const String:error[], any:client)
{
	...
	if(hndl == INVALID_HANDLE)
	{
		...
		//PrintToServer("Last Connect SQL Error: %s", error);
		//PrintToChatAll("\x04%N\x01 joined the fight.", client);
		PrintToChatAll("\x04%N\x01 %t", client, "joint_to_fight");
		return;
	}
	...
	if(SQL_FetchRow(hndl))
	{
		...
		// Get player count
		decl String:buffer[512];
		Format(buffer, sizeof(buffer),"SELECT COUNT(*) FROM hlstatsx WHERE score >= %i", iScore);
...
public SQLJoinMsgGetRank(Handle:owner, Handle:hndl, const String:error[], any:client)
{
	...
	if(SQL_FetchRow(hndl))
	{
		...
		// Get player count
		SQL_TQuery(g_hDB, SQLJoinMsgGetPlayerCount, "SELECT COUNT(*) FROM hlstatsx", client);
	}
	else
	{
		PrintToChatAll("\x04%N\x01 %t", client, "joint_to_fight");
...
public SQLGetMyRank(Handle:owner, Handle:hndl, const String:error[], any:client){
	...
	if(SQL_FetchRow(hndl)) 
	{
		...
		// 0.00027144
		//STEAM_0:1:13462423
		//Format(buffer, sizeof(buffer), "SELECT ((`deaths`/`kills`)/`played_time`) AS rankn FROM `hlstatsx` WHERE (`kills` > 0 AND `deaths` > 0) AND ((`deaths`/`kills`)/`played_time`) < (SELECT ((`deaths`/`kills`)/`played_time`) FROM `hlstatsx` WHERE steamId = '%s' LIMIT 1) AND `steamId` != '%s' ORDER BY rankn ASC", g_sSteamIdSave[client], g_sSteamIdSave[client]);
		
		// Get rank
		Format(buffer, sizeof(buffer), "SELECT COUNT(*) FROM hlstatsx WHERE score >= %i", RAscore);
		...
		PrintToChat(client,"%c %t", GREEN, "player_stats", RAscore, RAkills, RArevives, RAheals, RAdeaths, RAheadshots, RAsucsides);
	} else {
		PrintToChat(client, "%c %t", "your_rank_not_avaible", GREEN);
	}
}
...
public SQLGetRank(Handle:owner, Handle:hndl, const String:error[], any:client){
	...
	if(SQL_FetchRow(hndl)) 
	{
		...
		// Get player count
		SQL_TQuery(g_hDB, SQLShowRankToChat, "SELECT COUNT(*) FROM hlstatsx", client);
	} else {
		PrintToChat(client, "%c %t", "your_rank_not_avaible", GREEN);
	}
}
...
public SQLShowRankToChat(Handle:owner, Handle:hndl, const String:error[], any:client){
	...
	if(SQL_FetchRow(hndl)) 
	{
		...
		// Display rank
		PrintToChat(client,"%c %t", GREEN, "your_rank_is", g_iRank[client], iPlayerCount);
	} else {
		PrintToChat(client, "%c %t", "your_rank_not_avaible", GREEN);
	}
}
...
public SQLTopShow(Handle:owner, Handle:hndl, const String:error[], any:client){
	...
	new String:text[128];
	Format(text,127,"%t", "top_10_players");
	...
	if (SQL_HasResultSet(hndl))
	{
		...
		while (SQL_FetchRow(hndl))
		{
			...
			Format(text,127," %t", "player_stats_skd", score, kills, deaths);
			DrawPanelText(hPanel, text);
		}
	} else {
			Format(text,127,"%t", "top_10_empty");
			DrawPanelText(hPanel, text);
	}
...
public SQLTopShowMedic(Handle:owner, Handle:hndl, const String:error[], any:client){
	...
	if (SQL_HasResultSet(hndl))
	{
		...
		while (SQL_FetchRow(hndl))
		{
			...
			Format(text,127,"[%d] %s", row, name);
			DrawPanelText(hPanel, text);
			Format(text,127,"%t", "player_stats_rh", revives, heals);
			DrawPanelText(hPanel, text);
		}
	} else {
			Format(text,127,"%t", "top_med");
			DrawPanelText(hPanel, text);
	}
...
public Action:FireScreamCheckTimer(Handle:timer, any:entity){
	...
	for (new client = 1;client <= MaxClients;client++)
	{
		if (client <= 0 || !IsClientInGame(client) || !IsClientConnected(client))
			continue;
		if (owner <= 0 || owner > MaxClients || !IsClientInGame(owner) || !IsClientConnected(owner))
			continue;
		if (IsFakeClient(client))
			continue;
							...
							{	
								...
								if (iHealth < 100)
								{
									...
									if (iHealth >= 100)
									{
										...
										PrintCenterText(client, "%t", "medicpack_left", g_healthPack_Amount[entity]);
										PrintHintText(client, "%t", "medic_assisted_heal_you", iHealth);
									}
									else 
									{
										//PrintCenterText(client, "Medical Pack HP Left: %i", g_healthPack_Amount[entity]);
										...
										PrintCenterText(client,"%t", "medicpack_left", g_healthPack_Amount[entity]);
										PrintHintText(client, "%t", "medic_self_you_area_heal_you", iHealth);
							...
							else
							{
								...
								if ((StrContains(sWeapon, "weapon_knife") > -1))
								{
									...
									//PrintToServer("DEBUG 10");
											...
											PrintHintText(client, "%t", "you_healed_yourself", iHealth, g_nonMedicHealSelf_max);
										}
										else 
										{
											//PrintCenterText(client, "Medical Pack HP Left: %i", g_healthPack_Amount[entity]);
											...
											PrintCenterText(client, "%t", "medicpack_left", g_healthPack_Amount[entity]);
											PrintHintText(client,"%t", "you_healing_self", iHealth, g_nonMedicHealSelf_max);
										}
								...
								else if (iHealth < g_nonMedicHealSelf_max && !(StrContains(sWeapon, "weapon_knife") > -1))
								{
									...
									PrintHintText(client, "%t", "no_medics_pull_knife", iHealth);
								}
							}
							
						}
					} //Medic assist area heal and self heal
					else if ((StrContains(g_client_last_classstring[client], "template_demolitions_security_coop") > -1))
					{
						 decl Float:fPlayerOrigin[3];
						GetClientEyePosition(client, fPlayerOrigin);
						if (GetVectorDistance(fPlayerOrigin, fOrigin) <= Healthkit_Radius)
								...
								if (Check_NearbyMedics(client))
								{
									if (iHealth < 100)
									{
										...
										else 
										{
											...
											PrintCenterText(client, "%t", "medicpack_left", g_healthPack_Amount[entity]);
											PrintHintText(client, "%t", "medic_self_area_healing", iHealth);
										}
								...
								else
								{
									if (iHealth < g_medicHealSelf_max)
									{
										...
										if (iHealth >= g_medicHealSelf_max)
										{
											...
											PrintCenterText(client, "%t", "medicpack_left", g_healthPack_Amount[entity]);
											PrintHintText(client,"%t", "medic_self_you_area_heal_you", iHealth, g_medicHealSelf_max);
										}
										else 
										{
											//PrintCenterText(client, "Medical Pack HP Left: %i", g_healthPack_Amount[entity]);
											...
											PrintCenterText(client, "%t", "medicpack_left", g_healthPack_Amount[entity]);
											PrintHintText(client,"%t", "medic_self_area_heal_you", iHealth, g_medicHealSelf_max);
										}
									}
									else 
									{
										...
										PrintCenterText(client, "%t", "medicpack_left", g_healthPack_Amount[entity]);
										PrintHintText(client, "%t", "you_healed_yourself",iHealth, g_medicHealSelf_max);
									}
								}
							}
						}
...
public Check_NearbyMedics(client){
	for (new friendlyMedic = 1; friendlyMedic <= MaxClients; friendlyMedic++)
	{
		if (IsClientConnected(friendlyMedic) && IsClientInGame(friendlyMedic) && !IsFakeClient(friendlyMedic))
		{
			...
			if (IsPlayerAlive(friendlyMedic) && (StrContains(g_client_last_classstring[friendlyMedic], "template_demolitions_security_coop") > -1) && client != friendlyMedic)
			{
		...
		if (IsClientConnected(friendlyMedic) && IsClientInGame(friendlyMedic) && !IsFakeClient(friendlyMedic))
		{
			...
			if (IsPlayerAlive(friendlyMedic) && (StrContains(g_client_last_classstring[friendlyMedic], "template_demolitions_security_coop") > -1) && client != friendlyMedic)
			{
				...
				if (fDistance <= fReviveDistance && bCanHealPaddle)
				{
					...
					Format(sBuf, 255,"\x05%t\x01", "revived_msg_all_assisted", friendlyMedic, iInjured, woundType);
					PrintToChatAll("%s", sBuf);
					...
					Format(sBuf, 255,"%t", "revived_msg_medic_bonus_assisted", iInjured, woundType, (iReviveCap - g_playerMedicRevivessAccumulated[friendlyMedic]));
...
/*
######################## APTECHKA_V1 ######################
#	This portion of the script adds in health packs          		#
##############################START##################################
#####################################################################
*/
...
public OnEntityDestroyed(entity)
{
	if (entity > MaxClients)
	{
		...
		if (StrEqual(classname, "healthkit"))
		{
			StopSound(entity, SNDCHAN_STATIC, "custom/gameplay/health.ogg");
		}
    }
}
...
public Action:Healthkit(Handle:timer, Handle:hDatapack)
{
	...
	if (entity > 0 && IsValidEntity(entity) && fGameTime <= fEndTime)
	{
		...
		{
			g_fLastHeight[entity] = 0.0;
			EmitSoundToAll("custom/gameplay/health.ogg", entity, SNDCHAN_STATIC, _, _, 0.7);
		}
		fOrigin[2] += 16.0;
		TE_SetupBeamRingPoint(fOrigin, 10.0, Healthkit_Radius*1.95, g_iBeaconBeam, g_iBeaconHalo, 0, 30, 0.6, 3.0, 0.0, {97, 67, 23, 1}, 3, 0);
		TE_SendToAll();
		fOrigin[2] -= 16.0;
		if (fOrigin[2] != g_fLastHeight[entity])
		{
		...
		else
		{
			...
			if (fAng[2] > 89.0 || fAng[2] < -89.0)
			{
				...
				TeleportEntity(entity, fOrigin, fAng, Float:{0.0, 0.0, 0.0});
				fOrigin[2] += 6.0;
				EmitSoundToAll("cues/music_loop_01.wav", entity, SNDCHAN_STATIC, _, _, 1.0);
			}
		}
				...
				if (GetVectorDistance(fPlayerOrigin, fOrigin) <= Healthkit_Radius)
				{
					...
					if (!TR_DidHit(trace))
					{
						...
						if (iMaxHealth > iHealth)
						{
							...
							{
								EmitSoundToAll("custom/gameplay/breath_mid_3.wav", iPlayer, SNDCHAN_STATIC, _, _, 1.0);
								iHealth = iMaxHealth;
								PrintToChat(iPlayer, "\x05ProRussianServer \x01@ \x03Здоровье востановленно - You are completely healed!");
								PrintCenterText(iPlayer, "Здоровье !\n\n \n %d %%\n \n \n \n \n \n \n \n", iMaxHealth);
							}
							else PrintCenterText(iPlayer, "Лечение - Healing...\n\n \n   %d %%\n \n \n \n \n \n \n \n", iHealth);
							SetEntProp(iPlayer, Prop_Data, "m_iHealth", iHealth);
						}
						else PrintCenterText(iPlayer, "Вылечен - Healed !\n\n \n %d %%\n \n \n \n \n \n \n \n", iMaxHealth);
					}
				}
			}
		}
